...
\item[h$_j$ $_v$] 	é o h-ézimo segmento na versão \textit{j} do filme \textit{v}  ,todo segmento na versão j tem o mesmo tamanho e duração.
...
\item[W] 	tamanho da janela de tempo para download de H segmentos
...
Para este cenário, consideramos o problema de otimização da disponibilidade de segmentos de maior qualidade, em termos de bits recebidos na rede P2P,portanto, dado um conjunto S de  I pares e um conjunto J de versões de vídeo a taxas r decrescentes \vetr de um vídeo v (Tian:2013), é necessário decidir quantas cópias do segmento rjh serão criadas na comunidade, para que se mantenha ou diminua a carga sobre o servidor e considere a melhor percepção da qualidade de vídeo para o usuário dentro do swarm, conforme cenário ilustrado na figura 1.
