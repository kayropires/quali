...
Diante deste cenário é preciso empreender esforços para desenvolver e melhorar técnicas de distribuição de conteúdo, como os vídeos sob demanda abordados neste trabalho, de modo que, uma das propostas largamente adotadas por provedores de conteúdo é o streaming adaptativo sobre HTTP ( HTTP Adaptative streaming - HAS )
